...
<html lang="en">
  ...
  <body>
    ...
    <img src="<?= base_url('assets/image/') ?>/Kayuh_Baimbai.png" width="20%" height="20%" align="left"/>
            ...
            <tr>
              <td>
                ...
                <?php if($filter['filter_awal'] != null && $filter['filter_akhir'] != null): ?>
                  <?= date('d M Y', strtotime($filter['filter_awal'])) . " - " . date('d M Y', strtotime($filter['filter_akhir'])) ?> / Rentang Tanggal / Buku Tamu Member
                <?php endif; ?>
              </td>
              <td></td>
            </tr>
      ...
      <h3 class="text-center mb-2">LAPORAN BUKU TAMU MEMBER</h3>
